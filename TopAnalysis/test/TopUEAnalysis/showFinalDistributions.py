...
EXTRASETS = [
    ...
    ('#alpha_{S}^{ISR}=0.09','MC13TeV_TTJets_asisr0.09.root'),
    ('#alpha_{S}^{ISR}=0.10','MC13TeV_TTJets_asisr0.10.root'),
    ('#alpha_{S}^{ISR}=0.11','MC13TeV_TTJets_asisr0.11.root'),
    ('#alpha_{S}^{ISR}=0.12','MC13TeV_TTJets_asisr0.12.root'),
    ('#alpha_{S}^{ISR}=0.13','MC13TeV_TTJets_asisr0.13.root'),
    ('#alpha_{S}^{ISR}=0.14','MC13TeV_TTJets_asisr0.14.root'),
    ('#alpha_{S}^{ISR}=0.15','MC13TeV_TTJets_asisr0.15.root'),
    ('#alpha_{S}^{ISR}=0.16','MC13TeV_TTJets_asisr0.16.root'),
]
