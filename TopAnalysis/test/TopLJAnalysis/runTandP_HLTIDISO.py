...
process.TnP_Muon_IDISO = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    ...
    Categories = cms.PSet(
        ...
        hltL2fL1sSingleMu7BptxANDL1f0L2Filtered15     = cms.vstring("hltL2fL1sSingleMu7BptxANDL1f0L2Filtered12", "dummy[pass=1,fail=0]"),
    ...
    Efficiencies = cms.PSet(
        MuID_pt = cms.PSet(
            ...
            EfficiencyCategoryAndState = cms.vstring("hltL2fL1sSingleMu7BptxANDL1f0L2Filtered15","pass",
                                                     "Tight2012", "pass",
