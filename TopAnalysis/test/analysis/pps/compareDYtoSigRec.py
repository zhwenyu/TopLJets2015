...
sig='/eos/cms//store/cmst3/user/psilva/ExclusiveAna/final/2017_unblind_multi/Chunks/MC13TeV_Z_m_X_950_xangle_120_2017_postTS2_fullsim_0.root'
...
for t,v,c in [("p_{T}(ll) [GeV]",                 "bosonpt >> {0}(20,0,250)",   'isZ'),
              ...
              ('#Delta#phi[E_{T}^{miss},p_{T}(ll)] [rad]', "TVector2::Phi_mpi_pi(met_phi-bosonphi) >> {0}(20,-3.15,3.15)",     finalSel),
