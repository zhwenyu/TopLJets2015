...
cat /afs/cern.ch/work/w/wenyu/work/topwidth/CMSSW_9_4_10/src/TopLJets2015/TopAnalysis/test/analysis/top17010/0c522df/datacards1/em/nom/tbartfsrup.datacard.dat > datacard.dat
sed -i "s|pseudodata_999|pseudodata_${OUTNUM}|g" datacard.dat

#convert to HDF5 and run TF-based fits
text2hdf5.py datacard.dat
combinetf.py datacard.dat.hdf5 -o fitresults_tbartfsrup_${OUTNUM}.root --doImpacts
...
#cp -v fitresults_fixedgroups.pck /afs/cern.ch/user/w/wenyu/afswork/work/topwidth/CMSSW_9_4_10/src/TopLJets2015/TopAnalysis/test/analysis/top17010/0c522df/fits/em_inc/nom_err/fitresults_tbartfsrup_fixedgroups.pck
