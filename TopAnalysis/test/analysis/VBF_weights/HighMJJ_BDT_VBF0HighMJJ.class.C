...
NVar 6
ht                            ht                            ht                            ht                                                              'F'    [67.0356750488,1905.29638672]
forwardeta                    forwardeta                    forwardeta                    forwardeta                                                      'F'    [1.5133742094,4.68548536301]
balance                       balance                       balance                       balance                                                         'F'    [0.668380081654,438.643188477]
dphivj0                       dphivj0                       dphivj0                       dphivj0                                                         'F'    [0.00805723667145,3.14135885239]
mjj                           mjj                           mjj                           mjj                                                             'F'    [1000.04669189,5971.40917969]
...
{
  // itree = 0
  fBoostWeights.push_back(0.71628683428902);
  fForest.push_back( 
NN(
NN(
0, 
...
0, 387.88, 1, 0, 0.5,-99)    );
  // itree = 1
  fBoostWeights.push_back(0.370472);
  fForest.push_back( 
NN(
NN(
0, 
...
0, 
-1, 0, 1, -1, 0.40184,-99) , 
3, 2.80728, 1, 0, 0.489428,-99)    );
  // itree = 8
  fBoostWeights.push_back(0.0734316);
  fForest.push_back( 
NN(
NN(
0, 
