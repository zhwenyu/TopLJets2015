...
"""
def submitProduction(tag,lfnDirBase,dataset,isData,cfg,workDir,lumiMask,era='era2018',submit=False):
...
def main():
    ...
    parser.add_option(      '--era',         dest='era',         help='era to use (sub-dir in data/)', default='era2018',  type='string')
