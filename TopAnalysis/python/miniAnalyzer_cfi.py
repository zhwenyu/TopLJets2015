...
analysis = cms.EDAnalyzer("MiniAnalyzer",
                          ...
                          muTriggersToUse = cms.vstring('HLT_IsoMu22_v', 'HLT_IsoTkMu22_v',
                                                        'HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_v', 'HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_v'),
                          elTriggersToUse = cms.vstring('HLT_Ele27_WPTight_Gsf_v',
                                                        'HLT_Ele23_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_v',
                                                        'HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v', 'HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v')
                          )
