...
python scripts/submitToGrid.py -j data/era2017/samples.json -c ${CMSSW_BASE}/src/TopLJets2015/TopAnalysis/test/runL1PrefireAna_cfg.py --addParents --only Data --lfn /store/group/cmst3/group/top/psilva/l1prefire/2017 -w grid_prefire -s
```
