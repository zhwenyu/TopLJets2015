...
class SelectionTool {
 ...
 public:
  ...
  std::vector<Jet>      getGoodJets(MiniEvent_t &ev, double minPt = 30., double maxEta = 4.7, std::vector<Particle> leptons = {},std::vector<Particle> photons = {}, size_t jetUncIndx=-2); // changed for the moment to VBF
