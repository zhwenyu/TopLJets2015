...
struct MiniEvent_t
{
  ...
  Float_t l_pt[50],l_eta[50],l_phi[50], l_mass[50], l_scaleUnc[50],l_scaleUncBreakup[50][3], l_miniIso[50], l_chargedHadronIso[50], l_relIso[50], l_ip3d[50], l_ip3dsig[50],l_mva[50];
